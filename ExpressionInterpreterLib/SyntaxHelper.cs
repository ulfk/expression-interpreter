...
namespace ExpressionInterpreterLib
{
    public static class SyntaxHelper
    {
        ...
        public static void EnsureOnlyValidCharacters(this string expressionAsText)
        {
            ...
            onlyValidCharactersFound.AssertValidData($"Invalid characters in expression '{expressionAsText}'. {AllowedExpressionCharacters}");
        }
        ...
        private static bool IsConstant(this string numberString)
        {
        ...
        private static bool IsOperatorAdd(this string operatorCharacter) => operatorCharacter.EqualsChar('+');

        private static bool IsOperatorSub(this string operatorCharacter) => operatorCharacter.EqualsChar('-');

        private static bool IsOperatorMult(this string operatorCharacter) => operatorCharacter.EqualsChar('*');
