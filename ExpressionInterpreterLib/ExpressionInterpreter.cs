...
namespace ExpressionInterpreterLib
{
    public class ExpressionInterpreter : IExpressionInterpreter
    {
        ...
        {
            ResetInstance();
            (expressionAsText != null).AssertValidData("The parameter 'expressionAsText' cannot be NULL.");
        ...
        private void CreateExpressionTree(string expressionAsText)
        {
            ...
            ExceptionHelper.AssertValidSyntax(_bracketDepth == 0, "Missing closing bracket.");
        }
        ...
        /// Operator type to be used for operator node.
        /// </param>
        /// <param name="newNode">
        ...
        private Node MergeNodes(Node pendingNode, OperatorType operatorType, Node newNode)
        {
            ...
            ExceptionHelper.AssertValidSyntax(operatorType != OperatorType.Undefined, $"Missing operator at position {_expressionElementIndex}.");
        ...
        /// </returns>
        private static Node CreateScalarNode(string element) => element.IsVariable() ? new NodeVariable(element) : new NodeNumeric(element);
        ...
        private Node ProcessExpressionElements()
        {
            ...
            while(IsElementForProcessingAvailable)
            {
                ...
                {
                    ExceptionHelper.AssertValidSyntax(!firstElementInExpression, "First element of expression cannot be an operator.");
            ...
            ExceptionHelper.AssertValidSyntax(operatorType == OperatorType.Undefined, "Missing scalar at the end of the expression.");
            ExceptionHelper.AssertValidSyntax(pendingNode != null, "Missing element in expression.");
            ...
            ExceptionHelper.AssertValidSyntax(resultNode != null, "Missing element in expression.");
        ...
        {
            ExceptionHelper.AssertValidSyntax(_bracketDepth > 0, $"unexpected closing bracket at position {_expressionElementIndex}");
            _bracketDepth--;
        }
        ...
        {
            ExceptionHelper.AssertValidSyntax(_lastElementType == ElementType.Undefined || _lastElementType != elementType, 
                $"wrong element type '{_lastElementType}' at index {_expressionElementIndex}");
        }
